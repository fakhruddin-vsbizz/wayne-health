...
const CreateShippingAddress = () => {
    ...
    useEffect(() => {
        if (customerId) {
            ...
            axios
                .get("/api/admin/customer/shipping-address/" + customerId, {
                    headers: {
    ...
    const deleteAddress = (id) => {
        ...
        axios
            .delete("/api/admin/customer/shipping-address/" + id, {
                headers: {
                    Authorization: `Bearer ${token}`,
                    Accept: "application/json",
                },
            ...
            .then((data) => {
                ...
                if (data?.data?.success) {
                    ...
                    toast.success(data?.data?.success, toastOptions);
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post(
                `/api/admin/customer/shipping-address/${customerId}/store`,
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center gap-1">
                                    <Link
                                        to={
                                            "/admin/edit-customer-shipping-address/" +
                                            customerId +
                                            "/" +
                                            row.id
                                        }
