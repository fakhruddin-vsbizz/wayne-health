...
const EditCustomer = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setError({});
        axios
            .put("/api/admin/customer/" + customerId, JSON.stringify(fields), {
                headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
                },
            ...
            .then((data) => {
                ...
                if (data?.data) {
                    ...
                    //     data.data.token
                    // );
                    toast.success("Customer updates successfully", {
                        position: "top-right",
                        autoClose: 3000,
        ...
        <div className="container mx-auto p-4">
            ...
            <form className="grid grid-cols-1 gap-6">
                ...
                <div className="p-2 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Link
                        to={
                            "/admin/create-customer-shipping-address/" +
                            customerId
                        }
                        style={{ backgroundColor: secondaryYellow }}
                        className="block w-full bg-[#8c0327] hover:bg-[#6b0220] text-white font-bold py-3 px-4 rounded-full text-center"
                    >
