...
// import InputField from "./InputField"; // Assuming the InputField component is in the same directory
...
const AdminLogin = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post("/api/admin/login", JSON.stringify(data), {
                headers: {
            ...
            .then((data) => {
                if (data?.data?.token) {
                    ...
                    // localStorage.setItem("x-wayne-health-type", "is_Admin_23");
                    // setToken(data.data.token);
                    // setUserType("is_Admin_23");
        ...
        <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
            ...
            >
                <div
                    // style={{
                    //     background:
                    //         "linear-gradient(to right, #69e1f4, #37b9f3)",
                    // }}
