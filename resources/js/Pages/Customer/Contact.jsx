...
const Contact = () => {
    ...
    const sendContactEmail = (e) => {
        ...
        const emailHtml = ReactDOMServer.renderToStaticMarkup(
            <ContactMail {...newFields} />
        );

        axios
            .post(
                "/api/customer/send-contact-email",
                {
                    emailHtml: emailHtml,
                    phone: fields.phone,
                    email: fields.email,
    ...
    return (
        <div class="max-w-5xl max-lg:max-w-3xl mx-auto my-6 p-8 font-[sans-serif]">
            ...
            <div class="text-center px-6">
                ...
                <p class="text-sm text-gray-500 mt-4">
                    Have some Feedback or something on your mind we can help
                    with?
                </p>
            </div>
            ...
            <div
                style={{
                    border: `1px ${primaryYellow} solid`,
                    height: "500px",
                }}
                class="grid lg:grid-cols-3 items-start gap-4 p-4 text-gray-300 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12"
            >
                <div
                    style={{ height: "90%" }}
                    class="bg-[#011c2b] rounded-lg p-6 max-lg:order-1 mt-4"
                >
                    ...
                    <ul class="mt-16 space-y-8">
                        <li class="flex items-center">
                            ...
                            <a
                                ...
                                class="text-sm text-gray-300 ml-4"
                            >
                                tasneem@alyko.com
                            </a>
                        </li>
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div class="relative flex items-center">
                                {/* <input
                                    ...
                                    className="px-2 py-3 bg-white w-full text-sm text-gray-800 border-b contact-input border-gray-300 outline-none"
                                /> */}
                                <FormInputField
                                    type="text"
                                    name="first_name"
                            ...
                            <div class="relative flex items-center">
                                {/* <input
                                    ...
                                    class="px-2 py-3 bg-white w-full text-sm text-gray-800 border-b border-gray-300 contact-input outline-none"
                                /> */}
                                <FormInputField
                                    type="text"
                                    name="last_name"
                            ...
                            <div class="relative flex items-center sm:col-span-2">
                                <FormTextAreaField
                                    ...
                                    onChange={handleChange}
                                    className="px-2 pt-3 bg-white w-full text-sm text-gray-800 border-b border-gray-300 contact-input outline-none"
                                />
                                {/* <textarea
                                    placeholder="Write Message"
                                    rows="6"
                                    class="px-2 pt-3 bg-white w-full text-sm text-gray-800 border-b border-gray-300 contact-input outline-none"
                                ></textarea>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="#bbb"
                                    stroke="#bbb"
                                    class="w-[18px] h-[18px] absolute top-3 right-2"
                                    viewBox="0 0 682.667 682.667"
                                >
                                    <defs>
                                        <clipPath
